...
def main():
    """Demo the control flow analyzer for deploy-manager."""
    print("🔍 Control Flow Analyzer - Deploy Manager Demo")
    print("=" * 50)
    
    deploy_manager_path = "/opt/openproject/external/deploy-manager"
    analyzer = ControlFlowAnalyzer(deploy_manager_path)
