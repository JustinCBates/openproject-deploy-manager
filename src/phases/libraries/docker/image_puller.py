...
class ImagePuller:
    ...
    def pull(self, image: str, quiet: bool = False) -> PullResult:
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                already_exists = 'up to date' in result.stdout.lower() or 'up-to-date' in result.stdout.lower()
    ...
    def pull_multiple(self, images: List[str], quiet: bool = False) -> Dict[str, PullResult]:
        """
