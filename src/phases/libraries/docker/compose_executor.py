...
class ComposeExecutor:
    ...
    def execute(
        self, command: str, capture_output: bool = True, timeout: int = 300
    ) -> ExecutionResult:
        """
    ...
    def down(
        self, volumes: bool = False, remove_orphans: bool = True
    ) -> ExecutionResult:
        """
...
"""
    ...
    try:
        ...
        executor = ComposeExecutor(
            {"compose_file": compose_file, "project_name": "test-compose"}
        )
