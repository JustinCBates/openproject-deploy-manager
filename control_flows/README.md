...
This directory contains all control flow related files for the **deploy-manager** component.

## Files

### Documentation
- **`CONTROL_FLOWS.md`** - Current deployment flow documentation (generated/maintained)
- **`CONTROL_FLOWS_SPEC.md`** - Design-first specification (YAML-based, AI-friendly)

### Tools
- **`analyze_control_flows.py`** - Analyzer and validator for deployment flows
...
- **`demo_development_communication.py`** - Demo of deployment workflow
